...
from checkers.constants import PIECE_OUTLINE, HEADER_HEIGHT
...
class TestPiece(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.assertEqual(self.piece.y, SQUARE_SIZE * self.row + SQUARE_SIZE // 2 + HEADER_HEIGHT)
    ...
    def test_calc_pos(self):
        ...
        self.assertEqual(self.piece.y, SQUARE_SIZE * 4 + SQUARE_SIZE // 2 + HEADER_HEIGHT)
    ...
    def test_move(self):
        ...
        self.assertEqual(self.piece.y, SQUARE_SIZE * new_row + SQUARE_SIZE // 2 + HEADER_HEIGHT)
