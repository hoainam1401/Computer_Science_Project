...
from .constants import COLS, COMMENT, GRAY, GREEN, PURPLE, ROWS, SQUARE_SIZE
...
class Board:
    ...
    def __init__(self):
        self.board = []
        self.purple_left = self.green_left = 12
        self.purple_kings = self.green_kings = 0
        self.create_board()
    ...
    def evaluate(self):
        return (
            self.green_left
            - self.purple_left
            + (self.green_kings - self.purple_kings) * 0.5
        )
